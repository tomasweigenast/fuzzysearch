/// Code from https://github.com/agilord/diacritic/blob/master/lib/src/replacement_map.dart

bool _initialized = false;
final Map<int, int> _singleUnit = {};
final Map<int, List<int>> _multiUnit = {};
...
String removeDiacritics(String text) => String.fromCharCodes(_replaceCodeUnits(text.codeUnits));

/// Replaces list of code units to a simplified list.
/// The length of the result list may differ from the source.
List<int> _replaceCodeUnits(List<int> codeUnits) {
  _initIfRequired();
  final result = <int>[];
